...
echo increaseEnthusiasm("is it a women day"), "\n";

function repeatThreeTimes($str)
{
    return ($str.$str.$str);
}
echo repeatThreeTimes("8 march"), "\n";
echo increaseEnthusiasm(repeatThreeTimes("oh,nice")), "\n";
...
$user = array('name'=>'Dina', 'surname' => 'Katya', 'patronymic' => 'Arina');
echo $user['name'], " ", $user['surname'], " ", $user['patronymic'], "\n";

$date = array('year' => 2023, 'month' => 03, 'day' => 07);
